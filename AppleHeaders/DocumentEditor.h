...
@class ComposeBackEnd, EditingMessageWebView, EditingWebMessageController, HeadersEditor, LoadingOverlay, MFUUID, Message, NSDictionary, NSMutableDictionary, NSOperation, NSOperationQueue, NSToolbar, NSWindow, WebViewEditor;
...
@property(retain) id loadDelegate; // @synthesize loadDelegate=_loadDelegate;
